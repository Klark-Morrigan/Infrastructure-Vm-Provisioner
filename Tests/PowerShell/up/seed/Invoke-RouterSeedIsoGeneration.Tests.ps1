BeforeAll {
    ...
    . "$PSScriptRoot\..\..\..\..\hyper-v\ubuntu\PowerShell\up\seed\Initialize-SeedConfigDirectory.ps1"
    . "$PSScriptRoot\..\..\..\..\hyper-v\ubuntu\PowerShell\up\seed\New-CloudInitMetaData.ps1"
    ...
    . "$PSScriptRoot\..\..\..\..\hyper-v\ubuntu\PowerShell\up\seed\Format-CloudInitLiteralBlock.ps1"
    . "$PSScriptRoot\..\..\..\..\hyper-v\ubuntu\PowerShell\up\seed\Write-VmSeedIso.ps1"
    . "$PSScriptRoot\..\..\..\..\hyper-v\ubuntu\PowerShell\up\seed\Invoke-RouterSeedIsoGeneration.ps1"
