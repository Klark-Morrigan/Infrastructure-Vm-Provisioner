BeforeAll {
    ...
    . "$PSScriptRoot\..\..\..\..\hyper-v\ubuntu\PowerShell\up\timing\Invoke-WithSubStepTimer.ps1"
    . "$PSScriptRoot\..\..\..\..\hyper-v\ubuntu\PowerShell\up\timing\Write-PhaseTimingReport.ps1"
}
