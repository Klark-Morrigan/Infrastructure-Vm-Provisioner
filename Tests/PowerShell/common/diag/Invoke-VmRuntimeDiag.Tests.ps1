BeforeAll {
    ...
    # access pattern.
    . "$PSScriptRoot\..\..\..\..\hyper-v\ubuntu\PowerShell\common\diag\Get-VmDiagFolder.ps1"
    . "$PSScriptRoot\..\..\..\..\hyper-v\ubuntu\PowerShell\common\network\Get-VmAdapterIPv4.ps1"
    . "$PSScriptRoot\..\..\..\..\hyper-v\ubuntu\PowerShell\common\diag\Invoke-VmRuntimeDiag.ps1"
